...
using EVChargingStation.CARC.Application.HuyPD.Services.Commons;
...
namespace EVChargingStation.CARC.WebAPI.HuyPD.Architecture;
...
public static class IocContainer
{
    ...
    public static IServiceCollection SetupBusinessServicesLayer(this IServiceCollection services)
    {
        ...
        services.AddScoped<IVehicleHuyPDService, VehicleHuyPDService>();
